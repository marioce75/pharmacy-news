  ...
  try {
    ...
    for (let i = 0; i < articles.length; i += BATCH_SIZE) {
      ...
      try {
        ...
        // Match results to articles by id, then generate body for each
        for (const article of batch) {
          ...
          try {
            ...
            console.warn(`  [PHARMEDITOR] Body generation failed for ${article.id}: ${err.message}`);
          }
